...
import com.acodigo.godkant.activities.activity_main;
import com.acodigo.godkant.activities.activity_secondary_page;
import com.acodigo.godkant.common.constants;
import com.acodigo.godkant.database_favorite.database_favorite;
import com.acodigo.godkant.database_favorite.database_favorite_models;
import com.acodigo.godkant.database_favorite.database_favorite_save;
import com.acodigo.godkant.database_images.database_images;
import com.acodigo.godkant.database_questions.database_questions;
import com.acodigo.godkant.database_questions.database_questions_models;
...
public class activity_splash_screen extends AppCompatActivity {
    ...
    private void setConstants() {
        try {
            ...
            constants.sharedPreferencesSetDeviceCodeId(activity_splash_screen.this, Settings.Secure.getString(getContentResolver(), Settings.Secure.ANDROID_ID) + "-Android-AR");
        } catch (Exception ex) {
                ...
                if (connection == null) {
                    ...
                    if (rs.next()) {
                        if (rs.getInt("appStatus") == 0) {
                            ...
                            if (rs.getInt("appVersionArabic") > constants.sharedPreferencesAppVersion) {
                                booleanUpdate.set(true);
                            } else {
                                constants.sharedPreferencesSetIsDeveloper(activity_splash_screen.this, stringDeviceId.equals(rs.getString("developerIdArabic")));
